  ...
  return (
    <div className="pt-32 pb-20 max-w-5xl mx-auto px-6">
      ...
      {data.principles && data.principles.length > 0 && (
        <section className="mb-32">
          <h2 className="text-xs font-black uppercase tracking-[0.4em] text-[#11d493] mb-12">Core Philosophy</h2>
      ...
      {data.process && data.process.length > 0 && (
        <section className="mb-32">
          <h2 className="text-xs font-black uppercase tracking-[0.4em] text-[#11d493] mb-12">Working Process</h2>
