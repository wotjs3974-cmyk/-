      ...
      <div className="max-w-6xl mx-auto w-full">
        ...
        <div className="space-y-32">
          ...
          <div className="max-w-4xl mx-auto">
             <h2 className="text-[10px] font-black text-[#11d493] tracking-[0.5em] uppercase italic mb-10 text-center opacity-70">Project Intent</h2>
             <div className="text-center">
               <p className="text-3xl md:text-5xl font-black text-white leading-[1.4] tracking-tighter whitespace-pre-line uppercase italic">
                "{item.intent}"
               </p>
             </div>
          </div>
