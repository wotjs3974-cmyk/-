      ...
      <div className="grid md:grid-cols-12 gap-12 md:gap-20">
        ...
        <aside className="md:col-span-4 space-y-16">
          <div className="space-y-8">
            ...
            <div className="flex gap-4 pt-4">
              {data.instagram && (
                <a href={data.instagram} target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 bg-white/5 border border-white/10 px-4 md:px-6 py-3 hover:border-[#11d493]/50 hover:text-[#11d493] transition-all">
                  <Instagram size={18} />
          ...
          <div className="space-y-10">
            <h2 className="text-xs md:text-sm font-black uppercase tracking-[0.15em] text-[#11d493] italic">기술 스택 (Tech Stack)</h2>
            <div className="space-y-8">
          ...
          <div className="space-y-10">
            <h2 className="text-xs md:text-sm font-black uppercase tracking-[0.15em] text-[#11d493] italic">학력 (Education)</h2>
            <div className="space-y-8">
        ...
        <main className="md:col-span-8 space-y-24">
          <section className="space-y-16">
            <h2 className="text-xs md:text-sm font-black uppercase tracking-[0.15em] text-[#11d493] italic border-b border-[#11d493]/20 pb-4">경력 및 프로젝트 (Experience)</h2>
